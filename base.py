...
from ..utils import DEFAULT_HEIGHT, DEFAULT_WIDTH, get_random_string, JSONEncoderForHTML, JSONEncoderForHTML_daily
...
class BaseChart(object):
    ...
    def get_data_json_daily(self):
        return json.dumps(self.get_data(), cls=JSONEncoderForHTML_daily)
